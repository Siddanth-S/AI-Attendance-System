...
def teacher_tab_take_attendance():
    ...
    st.markdown("""
        <h2 style="color:#F1F5F9; margin-bottom:0.1rem;">Take Attendance</h2>
        <p style="color:#64748B; margin-top:0; margin-bottom:1rem;">Upload classroom photos or record audio to mark attendance automatically.</p>
    """, unsafe_allow_html=True)
...
def teacher_tab_manage_subjects():
    ...
    with col1:
        st.markdown("""
            <h2 style="color:#F1F5F9; margin-bottom:0.1rem;">Subjects</h2>
            <p style="color:#64748B; margin-top:0; margin-bottom:0.5rem;">Manage your classes and share join codes with students.</p>
        """, unsafe_allow_html=True)
    with col2:
    ...
    if subjects:
        for sub in subjects:
            ...
            def share_btn(s=sub):
                if st.button(f"🔗 Share · {s['name']}", key=f"share_{s['subject_code']}"):
...
def teacher_tab_attendance_records():
    st.markdown("""
        <h2 style="color:#F1F5F9; margin-bottom:0.1rem;">Attendance Records</h2>
        <p style="color:#64748B; margin-top:0; margin-bottom:1rem;">History of all attendance sessions across your subjects.</p>
    """, unsafe_allow_html=True)
...
def teacher_screen_login():
    ...
    st.markdown("""
        <div style="margin-top:2rem; margin-bottom:1.5rem;">
            <h2 style="color:#F1F5F9; margin:0;">Teacher Login</h2>
            <p style="color:#64748B; margin:0.25rem 0 0 0;">Sign in to manage your subjects and take attendance.</p>
        </div>
    """, unsafe_allow_html=True)
...
def teacher_screen_register():
    ...
    st.markdown("""
        <div style="margin-top:2rem; margin-bottom:1.5rem;">
            <h2 style="color:#F1F5F9; margin:0;">Create Teacher Account</h2>
            <p style="color:#64748B; margin:0.25rem 0 0 0;">Set up your profile to start taking AI-powered attendance.</p>
        </div>
    """, unsafe_allow_html=True)
